...
TEST(consecutive_frame_send_test, consecutive_frame_send_8byte_2_frames_no_flow_control) {
    ...
    expect_isotp_user_send_can(user_context, CAN_MESSAGE_ID, EXPECTED_DATA_1, sizeof(EXPECTED_DATA_1), ISOTP_RET_OK);
    ...
    expect_isotp_user_send_can(user_context, CAN_MESSAGE_ID, EXPECTED_DATA_2, sizeof(EXPECTED_DATA_2), ISOTP_RET_OK);
    isotp_poll(&link);
}
...
TEST(consecutive_frame_send_test, consecutive_frame_send_8byte_5_frames_no_flow_control) {
    ...
    expect_isotp_user_send_can(user_context, CAN_MESSAGE_ID, EXPECTED_DATA_3, sizeof(EXPECTED_DATA_3), ISOTP_RET_OK);
    isotp_poll(&link);

    expect_isotp_user_send_can(user_context, CAN_MESSAGE_ID, EXPECTED_DATA_4, sizeof(EXPECTED_DATA_4), ISOTP_RET_OK);
    isotp_poll(&link);

    expect_isotp_user_send_can(user_context, CAN_MESSAGE_ID, EXPECTED_DATA_5, sizeof(EXPECTED_DATA_5), ISOTP_RET_OK);
    isotp_poll(&link);
}
